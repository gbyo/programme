...
/// Frozen V1 model graph, byte-for-byte the shape Programme shipped before
/// match locations existed. These types exist for one job only: letting the
/// V1 → V2 migration stage read a real V1 store.
///
...
/// Do not add features here; V1 is history.
enum SchemaV1Models {
    ...
    final class MatchModel {
        ...
        // No locationData: V1 predates match locations.
